...
import BlockTransaction from '../components/pages/block/BlockTransaction';
        ...
        <>
            <BrowserRouter basename='/'>
                ...
                <Routes>
                    ...
                    <Route path="/tx/:txnhash" element={<TransactionContractDetails />} />
                    <Route path="/address/:address" element={<Address />} />
                    <Route path="/account" element={<Account />} />
                    <Route path="/block" element={<Block />} />
                    <Route path="/alltransaction" element={<AllTransaction />} />
                    <Route path="/block_details/block/:number" element={<BlockDetails />} />
                    <Route path="/block/txs/:number" element={<BlockTransaction/>} />
