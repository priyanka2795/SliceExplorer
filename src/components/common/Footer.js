...
//     const params = [{
//       chainId: '0x5A3',//1443
//       chainName: 'Slice Testnet',
//       nativeCurrency: {
//         name: 'Slice',
//         symbol: 'SLICE',
//         decimals: 18
//       },
//       rpcUrls: ['https://test-slice-rpc.com/'],
//       blockExplorerUrls: ['https://testnet-slicescan.io/']
//     }]
    
//     injectedProvider.request({ method: 'wallet_addEthereumChain', params })
//       .then(() => console.log('Success'))
//       .catch((error: Error) => console.log("Error", error.message))
// }

const addSlice = () => {
  console.log("Slice Mainnet")
    ...
    const params = [{
      chainId: '0x7E4',//2020
      chainName: 'Slice Mainnet',
      nativeCurrency: {
        name: 'Slice',
        symbol: 'SLICE',
        decimals: 18
      },
      rpcUrls: ['https://mainnet-slice-rpc.com/'],
      blockExplorerUrls: ['https://slicescan.io/']
    }]
      ...
      <footer className='footer_wrap'>
        <Container>
          <div className='footer_btns'>
            <button className='add_btn' onClick={addSlice}>
