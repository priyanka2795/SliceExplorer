                            ...
                            <Container>
                                ...
                                <Navbar.Collapse id="basic-navbar-nav">
                                    <Nav className="ms-auto">
                                        ...
                                        <button className='navbar_link' id="blockchainSubMenu">
                                            ...
                                            <div className='blockchain_dropdown'>
                                                <ul>
                                                    ...
                                                    <li> <Link to="/verifyContract">Verified Contracts</Link></li>
                                                </ul>
                                            </div>
                                        </button>
                                    ...
                                    <div className='validator_dropdown'>
                                        ...
                                        <button className='navbar_link' id="tokenSubMenu">
                                            <span>Tokens <FaAngleDown /></span>
                                            <div className='token_dropdown'>
                                                <ul>
                                                    <li><Link to='/'>SLICE-20 tokens</Link></li>
                                        ...
                                        <button className='navbar_link' id="miscSubMenu">
