...
const VerifyContract = () => {
    ...
    const submitHandler = async () => {
        ...
        var isAddress = Web3.utils.isAddress(contractAddress)
                        ...
                        <Col lg={6}>
                            <div className='verify_contract_form'>
                                <div className='contract_input'>
                                    ...
                                    <p className='error_msg' id='validcontractAddressErr'>*Please enter the valid Contract Address</p>
                                </div><br></br>
