            ...
            Web3.eth.net.isListening()
                .then((data) => {
                    if (data) {
                        Web3.eth.getTransaction(id.txnhash)
                            .then((data) => {
                                ...
                                if (data) {
                                    ...
                                    console.log(data);
                                    if (data.to === null) {
                                        Web3.eth.getTransactionReceipt(data.hash).then(e => {
                                            setContractAddressValue(e.contractAddress)
                                        })
                        ...
                        Web3.eth.getTransactionReceipt(id.txnhash).then(e => {
                            console.log(e);
                        })
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-md-8'>
                                                <div className='right_side '>
                                                    ...
                                                    >
                                                        <CopyToClipboard text={result.from}>
                                                            <BiCopy onClick={handleSourceCopy} />
                                                        </CopyToClipboard>
                                                    </OverlayTrigger>
                                                </div>
                                            ...
                                            <div className='col-md-8'>
                                                <div className='right_side d-flex align-items-center'>
                                                    {result.to === null ?
                                                        <div>
                                                            <span> [Contract </span>
                                                            <Link to={`/address/${ContractAddressValue}`}>{ContractAddressValue}</Link>
                                                            <span className='mr-2'> Created] <FaCheckCircle style={{ color: '#0cbc6a' }} /></span>
                                                        </div>
                                                        :
                                                    ...
                                                    >
                                                        <CopyToClipboard text={result.to === null ? ContractAddressValue : result.to}>
                                                            <BiCopy onClick={handleSourceCopy} />
                                                        </CopyToClipboard>
                                                    </OverlayTrigger>
