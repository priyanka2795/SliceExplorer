                                    ...
                                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        {AddressCheck ?
                                            <>
                                                ...
                                                <button className="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Contract <FaCheckCircle style={{color:'#0bcf86', marginTop : '-16px'}}/> </button>
                                            </>
